...
const generatePinCode = () => Math.random().toString(36).substring(2, 8).toUpperCase();
...
export async function POST(request: Request) {
    ...
    try {
        ...
        return NextResponse.json({ message: "PIN generated and email sent", pinCode: newCustomer.pinCode });
    } catch (error) {
